...
class YoutubeChannelThumbnailObjectCreateError(Exception):
    pass


class YoutubeChannelThumbnailObjectCreator(ABC):
    @abstractmethod
    async def create_youtube_channel_thumbnail_object(
        ...
        """
        Args:
            remote_youtube_channel_thumbnail_url (str): サムネイルのURL
