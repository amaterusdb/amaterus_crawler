...
class CrawlerYoutubeChannelLiveUpdateTaskYoutubeChannel(BaseModel):
...
class GetUpdatableYoutubeChannelsResponseBodyData(BaseModel):
    crawler__youtube_channel_live_update_task__youtube_channels: list[
        CrawlerYoutubeChannelLiveUpdateTaskYoutubeChannel
    ]
...
query GetUpdatableYoutubeChannels {
  crawler__youtube_channel_live_update_task__youtube_channels(
    where: {
      auto_update_enabled: {
        _eq: true
      }
...
""",
        ...
        crawler_youtube_channels = (
            response_body.data.crawler__youtube_channel_live_update_task__youtube_channels
        )
