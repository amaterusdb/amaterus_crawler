...
class DownloadYoutubeVideoConfigOptions(BaseModel):
...
class DownloadYoutubeVideoConfig(BaseModel):
    type: Literal["download_youtube_video"]
    enabled: bool
    options: DownloadYoutubeVideoConfigOptions | None = None
